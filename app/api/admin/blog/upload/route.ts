...
} from "@/lib/utils/blog-image-storage";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const storagePath = buildBlogImageStoragePath(safeOriginalName, extension);
    ...
    console.error("Blog image upload route error:", error);
    return NextResponse.json(
      {
        success: false,
